    ...
    return (
        <section className="suggest">
            <div className="container">
                <h2 className="line-chuhui pt-5 text-bold">Gợi ý các dây hụi uy tín</h2>
                ...
                <div className="slider-container center-mobile">
                    <div className="swiper-container card-slider">
                        ...
                        <div className="swiper-slide hidden-suggest">
                            <div className="container testimonial-card" style={{ padding: '32px' }}>
                                <div className="member d-flex">
                                    <div className="justify-content-lg-start">
                                        <div className="m-3">
                                            <p>Bắt đầu hoạt động từ: 24/02/2021</p>
                                            <p>Chủ trương hội: Hoạt động năng nổ</p>
                                            <p>Số lượng thành viên: 15</p>
                                            <p className="mb-3">Mức độ đánh giá: Cực tốt</p>
                                        </div>

                                        <div className="d-flex">
                                            <img className="m-2" src={avatar} style={{ width: '48px', height: '48px' }} />
                                            <div>
                        ...
                        <div className="text-center button-dropdown">
                            <svg className="mb-2" width="81" height="35" viewBox="0 0 81 35" fill="none"
